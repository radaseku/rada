<?php
 if(Auth::user()->adminRole->name != 'superadmin')
  {
...
<head>
	...
	<title>Super Admin | <?php echo e(config('app.name')); ?></title>
...
<body>
	<div class="wrapper">
		...
		<!-- Sidebar -->
        <?php echo $__env->make('partials.super-side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /end sidebar -->
...
</html><?php /**PATH D:\xampp\htdocs\radaweb\resources\views/layouts/super.blade.php ENDPATH**/ ?>