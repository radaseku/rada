<?php
 if(Auth::user()->adminRole->name != 'contentcreator')
  {
...
<head>
	...
	<title>Content Creator | <?php echo e(config('app.name')); ?></title>
...
<body>
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="green">
				...
				<a href="" class="logo">
					<span class="navbar-brand text-white"><?php echo e(config('app.name')); ?></span>
				</a>
		...
		<!-- Sidebar -->
        <?php echo $__env->make('partials.content-side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /end sidebar -->
	...
	<?php if(isset($doughchart)): ?>
		<?php echo $doughchart->script(); ?>

	<?php endif; ?>
	<?php if(isset($weekchart)): ?>
		<?php echo $weekchart->script(); ?>
...
</html><?php /**PATH D:\xampp\htdocs\radaweb\resources\views/layouts/content.blade.php ENDPATH**/ ?>